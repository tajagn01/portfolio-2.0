    ...
    return (
        <div className="relative px-6 py-10 border border-zinc-200 dark:border-zinc-800 rounded-xl mt-8">
            ...
            <svg
                ...
                width="105"
                height="78"
                className="absolute top-6 left-6 fill-zinc-200 dark:fill-white/10"
            >
            ...
            {/* Quote Text */}
            <p className="relative z-10 italic text-pretty font-mono font-medium text-zinc-900 dark:text-zinc-300 mb-4">
                &quot;{quote.content}&quot;
            </p>

            {/* Quote Attribution */}
            <p className="text-right italic text-pretty font-mono text-black dark:text-white">
                — {quote.author}
            </p>
        </div>
    );
