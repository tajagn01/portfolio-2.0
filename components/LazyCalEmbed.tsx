...
const CalEmbed = dynamic(
    ...
    }),
    {
        ssr: false,
        loading: () => (
            <div className="inline-flex items-center text-sm bg-black/5 dark:bg-white/15 border border-zinc-200 dark:border-zinc-800 py-2 px-3 rounded-md">
